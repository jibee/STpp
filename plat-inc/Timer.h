...
class Timer {
	...
	public:
        ...
        */
		Timer& setCounter(unsigned short value);
        ...
        * */
         ...
         * */
		Timer& setChannelComparator(int channel, uint16_t referenceValue);
         ...
         * */
		uint16_t getChannelComparator(int channel);
         ...
         * */
		__attribute__((deprecated)) Timer& setCaptureCompare1Sel(int);
        /** Set the capture and compare 2 selection. 
         * 
         * @deprecated use setChannelDirection instead
         * */
		__attribute__((deprecated)) Timer& setCaptureCompare2Sel(int);
